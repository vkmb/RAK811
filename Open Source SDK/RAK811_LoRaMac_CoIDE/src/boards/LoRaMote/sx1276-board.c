...
void SX1276IoInit( void )
{
    ...
    GpioInit( &ioPin, RADIO_TCXO_EN, PIN_OUTPUT, PIN_PUSH_PULL, PIN_NO_PULL, 1 );
...
void SX1276IoDeInit( void )
{
    ...
    GpioInit( &ioPin, RADIO_TCXO_EN, PIN_OUTPUT, PIN_PUSH_PULL, PIN_NO_PULL, 0);
...
void SX1276AntSwInit( void )
{
    ...
    GpioInit( &AntSwitchTxPa, RADIO_ANT_SWITCH_TX_PA, PIN_OUTPUT, PIN_PUSH_PULL, PIN_PULL_UP, 1 );
}

void SX1276AntSwDeInit( void )
{
    GpioInit( &AntSwitchRx, RADIO_ANT_SWITCH_RX, PIN_OUTPUT, PIN_OPEN_DRAIN, PIN_NO_PULL, 1 );
    GpioInit( &AntSwitchTxPa, RADIO_ANT_SWITCH_TX_PA, PIN_OUTPUT, PIN_OPEN_DRAIN, PIN_NO_PULL, 0 );
}
